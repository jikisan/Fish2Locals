...
import Adapters.AdapterSellersOrdersItem;
import Models.Orders;

public class Sellers_Order_In_Transit_Fragment extends Fragment {

    private List<Orders> arrOrders = new ArrayList<>();
    private List<String> arrProductIds = new ArrayList<>();
    private AdapterSellersOrdersItem adapterSellersOrdersItem;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sellers__order__in__transit_, container, false);
    ...
    private void generateRecyclerLayout() {
        ...
        adapterSellersOrdersItem = new AdapterSellersOrdersItem(arrOrders, getContext());
        rv_myOrders.setAdapter(adapterSellersOrdersItem);
    ...
    private void getViewHolderValues() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapterSellersOrdersItem.notifyDataSetChanged();
            }
